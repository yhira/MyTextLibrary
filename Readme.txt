...
◆編集機能
    ...
    ぼすことはありません。
  ＊作者はDelphiとHTML以外使用したことがなく、それ以外はよく分からないのでデフ
  ォルトの目次対象文字は設定してません。強調表示は某エディタを参考にして設定し
  ましたがカラー表示が明らかにおかしいというところがあればメールか掲示板で指摘
  して頂けると有り難いです。デフォルトで目次対象文字に登録しておいた方がよいと
  思われる予約語などのご意見もお待ちしてます。
